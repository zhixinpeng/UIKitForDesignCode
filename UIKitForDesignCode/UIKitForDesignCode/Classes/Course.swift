...
class Course {
    ...
    init(title: String, subtitle: String, description: String, icon: UIImage, banner: UIImage, authors: [String]? = nil, colors: [CGColor]? = nil, background: UIImage? = nil, sections: [Section]? = nil) {
